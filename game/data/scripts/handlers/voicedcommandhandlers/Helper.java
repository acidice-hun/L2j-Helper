...
public class Helper implements IVoicedCommandHandler {
    ...
    {
        /*
         * [ID] = Level,Description,Icon
         */

        /* Songs */
        SkillSongs.put(264, new String[] {"1","Increases the P. Def. of all party members by 25%.","icon.skill0264"});
        SkillSongs.put(265, new String[] {"1","Increases HP Regeneration of all party members by 20%.","icon.skill0265"});
        SkillSongs.put(266, new String[] {"1","Increases the evasion of all party members by 3.","icon.skill0266"});
        SkillSongs.put(267, new String[] {"1","Increases the M. Def. of all party members by 30%.","icon.skill0267"});
        SkillSongs.put(268, new String[] {"1","Increases the movement speed of all party members by 20.","icon.skill0268"});
        SkillSongs.put(269, new String[] {"1","Increases the critical attack rate of all party members by 100%.","icon.skill0269"});
        SkillSongs.put(270, new String[] {"1","Increases the resistance of all party members to Dark attacks by 20.","icon.skill0270"});
        SkillSongs.put(304, new String[] {"1","Increases Max HP of all party members by 30%.","icon.skill0304"});
        SkillSongs.put(305, new String[] {"1","Gives a party member the ability to transfer 20% of received standard short-range damage back to the enemy.","icon.skill0305"});
        SkillSongs.put(306, new String[] {"1","Increases party members resistance to fire attacks by 30.","icon.skill0306"});
        SkillSongs.put(308, new String[] {"1","Increases party members resistance to wind attacks by 30.","icon.skill0308"});
        SkillSongs.put(349, new String[] {"1","Decreases all party members physical&amp;magic skill MP consumption by 5% and re-use time by 20%.","icon.skill0349"});
        SkillSongs.put(363, new String[] {"1","Increases all party members MP recovery bonus by 20%, and decreases magic skill use MP consumption by 10%.","icon.skill0363"});
        SkillSongs.put(364, new String[] {"1","Decreases all party members physical skill use and song&amp;dance skill use MP consumption by 20% and physical skill and song&amp;dance skill reuse time by 10%.","icon.skill0364"});
        SkillSongs.put(529, new String[] {"1","Increases all party members resistance to fire, water, wind and earth attacks by 30.","icon.skill0529"});
        SkillSongs.put(764, new String[] {"1","Increases a party members tolerance to bows by 30.","icon.skill0764"});

        /* Dances */
        SkillDances.put(271, new String[] {"1","Increases the P. Atk. of all party members by 12%.","icon.skill0271"});
        SkillDances.put(272, new String[] {"1","Increases the accuracy of all party members by 4.","icon.skill0272"});
        SkillDances.put(273, new String[] {"1","Increases the M. Atk. of all party members by 20%.","icon.skill0273"});
        SkillDances.put(274, new String[] {"1","Increases the critical attack power of all party members by 35%.","icon.skill0274"});
        SkillDances.put(275, new String[] {"1","Increases the Atk. Spd. of all party members by 15%.","icon.skill0275"});
        SkillDances.put(276, new String[] {"1","Decreases the magic-canceling damage of all party members by 40 and increases Casting Spd. by 30%.","icon.skill0276"});
        SkillDances.put(277, new String[] {"1","Increases the divine attribute P. Atk. of all party members by 20.","icon.skill0277"});
        SkillDances.put(307, new String[] {"1","Increases party members resistance to water attacks by 30.","icon.skill0307"});
        SkillDances.put(309, new String[] {"1","Increases party members resistance to earth attacks by 30.","icon.skill0309"});
        SkillDances.put(310, new String[] {"1","Gives all party members the ability to recover as HP 8% of any standard short-range physical damage inflicted on the enemy.","icon.skill0310"});
        SkillDances.put(311, new String[] {"1","Gives all party members the ability to decrease by 30 any environment-related damage received.","icon.skill0311"});
        SkillDances.put(365, new String[] {"1","Increases all party members damage magic critical attack rate by 100%.","icon.skill0365"});
        SkillDances.put(366, new String[] {"1","Decreases all party members movement speed by 50% and prevents them from being pre-emptively attacked by monsters.","icon.skill0366"});
        SkillDances.put(530, new String[] {"1","Increases all party members resistance to divine or Dark attacks by 30.","icon.skill0530"});
        SkillDances.put(915, new String[] {"1","Decreases a party members P. Def., M. Def. and evasion, and increases their P. Atk., M. Atk., Atk. Spd., Casting Spd. and movement speed.","icon.skill0915"});
    ...
    {
        if(Html.containsKey("getDefault"))
        {
            this.html = Html.get("getDefault");
        }
        else
        {
    ...
    private void getEnchant()
    {
        if(L2HelperEnchant == true)
        {
            if(Html.containsKey("getEnchant"))
            {
                this.html = Html.get("getEnchant");
            }
            else
            {
                String type = "";
    ...
    private void getBuffer()
    {
        if(L2HelperBuffer == true)
        {
            if(Html.containsKey("getBuffer"))
            {
                this.html = Html.get("getBuffer");
            }
            else
            {
                ...
                this.html += "<table border=0 cellpadding=0 cellspacing=0 width=292 height=358 background=\"L2UI_CH3.refinewnd_back_Pattern\"><tr><td valign=\"top\" align=\"center\">";
                    ...
                    this.html += "<table border=0 cellpadding=0 cellspacing=0>";
                        ...
                        this.html += "<td align=center><button action=\"bypass -h voice .helper\" value=\"Back\" width=240 height=32 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>";
                        this.html += "</tr>";
                    this.html += "</table><br><br><br>";
                this.html += "</td></tr></table>";
                this.html += "</body></html>";

                Html.put("getBuffer", this.html);
            }
        }
    }
    private void getBufferBuffs(String page)
    {
        if(L2HelperBufferBuffs == true)
        {
            ...
            {
                this.html = "<html><body><title>Lineage II Helper</title>";
                this.html += "<table border=0 cellpadding=0 cellspacing=0 width=292><tr><td valign=\"top\" align=\"center\">";
                    this.html += "<br><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32><br>";

                    this.html += "<table border=0 cellpadding=0 cellspacing=0><tr>";
                    if(pg == 0) {
                        this.html += "<td width=\"100\"></td>";
                        ...
                        this.html += "<td align=\"left\" width=\"100\"><button action=\"bypass -h voice .helper view buffer h1-0\" value=\"Preview\" width=80 height=22 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>";
                        ...
                        this.html += "<td align=\"left\" width=\"100\"><button action=\"bypass -h voice .helper view buffer h1-1\" value=\"Preview\" width=80 height=22 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>";
                        this.html += "<td width=\"100\"></td>";
                    }
                    ...
                    for (Iterator<Integer> it = SkillBuffs.keySet().iterator(); it.hasNext();) {
                        ...
                        if(pg == 0 && i >= 0 && i < 24) {
                            ...
                            if(L2HelperBufferIcon == true) {
                                this.html += "<td align=\"left\" width=\"40\"><img src="+skill[2]+" width=32 height=32></td>";
                                ...
                                this.html += "<td align=\"center\" width=\"240\"><button action=\"bypass -h voice .helper view buffer h1 "+key+"\" value=\""+name+"\" width=220 height=22 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>";
                            }
                            this.html += "</tr>";
                ...
                this.html += "<table border=0 cellpadding=0 cellspacing=0 width=292><tr><td valign=\"top\" align=\"center\">";
                    ...
                    for (Iterator<Integer> it = SkillSongs.keySet().iterator(); it.hasNext();) {
                        ...
                        if(L2HelperBufferIcon == true) {
                            ...
                            this.html += "<td align=\"center\" width=\"240\"><button action=\"bypass -h voice .helper view buffer h2 "+key+"\" value=\""+name+"\" width=220 height=22 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>";
                        }
                        this.html += "</tr>";
                    }
                    this.html += "</table>";
                ...
                this.html += "<table border=0 cellpadding=0 cellspacing=0 width=292><tr><td valign=\"top\" align=\"center\">";
                    ...
                    for (Iterator<Integer> it = SkillDances.keySet().iterator(); it.hasNext();) {
                        ...
                        if(L2HelperBufferIcon == true) {
                            ...
                            this.html += "<td align=\"center\" width=\"240\"><button action=\"bypass -h voice .helper view buffer h3 "+key+"\" value=\""+name+"\" width=220 height=22 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>";
                        }
                        this.html += "</tr>";
                    }
                    this.html += "</table>";
                ...
                this.html += "<table border=0 cellpadding=0 cellspacing=0 width=292><tr><td valign=\"top\" align=\"center\">";
                    ...
                    for (Iterator<Integer> it = SkillSpecial.keySet().iterator(); it.hasNext();) {
                        ...
                        if(L2HelperBufferIcon == true) {
                            ...
                            this.html += "<td align=\"center\" width=\"240\"><button action=\"bypass -h voice .helper view buffer h4 "+key+"\" value=\""+name+"\" width=220 height=22 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>";
                        }
                        this.html += "</tr>";
                    }
                    this.html += "</table>";
